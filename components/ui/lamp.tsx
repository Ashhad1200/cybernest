    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          ...
          <div className="absolute h-40 w-[100%] right-0 dark:bg-black bg-white bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        </motion.div>
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-white dark:bg-cyan-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
        ...
        <div className="absolute inset-auto z-40 h-50 w-full -translate-y-[12.5rem] dark:bg-black bg-white"></div>
      </div>
